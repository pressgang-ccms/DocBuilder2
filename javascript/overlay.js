            ...
            $.getJSON(topicNodesUrl, function(topicNodeData) {
                ...
                if (newerTopicRevisions.length != 0) {
                    var button = '<div class="btn-group" style="margin-bottom: 8px;">\
                        <button type="button" class="btn btn-info" style="width:230px; white-space: normal;" onclick="javascript:topicSections[' + topic.id + '].scrollIntoView()">' + bug.summary + '</button>\
