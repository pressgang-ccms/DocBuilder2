...
function buildBookElement(bookElement, title) {
    ...
    var lastBuild = '';
    var menuFreezeSpec = '<li><a href="javascript:void(0)" onclick="javascript:freezeSpec(\'' + UI_URL + '/#ContentSpecFilteredResultsAndContentSpecView\', ' + bookElement.idRaw + ')">Freeze Spec</a></li>';
    var menuObsoleteSpec = '<li><a href="javascript:void(0)" onclick="javascript:obsoleteSpec(false, \'' + REST_SERVER + '\', ' + bookElement.idRaw + ')">Obsolete Spec</a></li>';
