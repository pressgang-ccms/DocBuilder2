(function(){
    ...
    if (isDocbuilderWindow() && unsafeWindow.getSpecIdFromURL) {
        ...
        var process = function (json) {
            ...
            var timelineChartDiv = jQuery('<div data-pressgangtopic="24986" id="timelineChartDiv" style="background-color: white; position: absolute; top:' + TIMELINE_VERTICAL_OFFSET + 'px; left: ' + leftSide + 'px; right: ' + rightside + 'px; height: ' + timelineDisplayHeight + 'px; overflow: auto;"></div>');
            ...
            setTimeout(function() {
                ...
                var x = 0,
                    ...
                    pathes = {},
                    lgnd2 = jQuery('<div data-pressgangtopic="24986" id="pressgangschedulelegend" style="background-color: white; position: absolute; top: 8px; left: ' + leftSide + 'px; width: 24px; height: 24px;"></div>'),
                    usrnm2 = jQuery('<div data-pressgangtopic="24986" id="pressgangscheduleprocessname" style="background-color: white; position: absolute; top: 8px; left: ' + (leftSide + 32) + 'px"></div>'),
                    today = jQuery('<button data-pressgangtopic="24986" id="productpagestodaybutton" type="button" style="background-color: white; position: absolute; top: 8px; right: ' + rightside + 'px" class="btn btn-default btn-xs">Show Today</button>');
        ...
        var specProductUrl = getRESTServerUrl() + "1/contentspec/get/json+text/" + specId;
        ...
        setTimeout(function(){
            GM_xmlhttpRequest({
                ...
                onload: function(specResponse) {
                    ...
                    // 6 is the comment node type
                    var stringConstant = getRESTServerUrl() + "1/stringconstant/get/json/74";
